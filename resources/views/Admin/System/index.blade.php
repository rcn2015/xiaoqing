...
<div id="urHere">DouPHP 管理中心<b>></b><strong>系统设置</strong> </div>   <div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
    ...
    <div class="idTabs">
      ...
      <div class="items">
       <form action="/Systems" method="post" enctype="multipart/form-data">
        ...
        <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
         <tr>
          ...
          <td>
                      <input type="text" name="name" value="DouPHP轻量级企业网站管理系统" size="80" class="inpMain" />
                                </td>
         </tr>
                  <tr>
          <td align="right">站点标题</td>
          <td>
                      <input type="text" name="title" value="DouPHP轻量级企业网站管理系统" size="80" class="inpMain" />
                                </td>
         </tr>
                  <tr>
          <td align="right">站点关键字</td>
          <td>
                      <input type="text" name="keywords" value="DouPHP,轻量级企业网站管理系统" size="80" class="inpMain" />
                                </td>
         </tr>
                  <tr>
          <td align="right">站点描述</td>
          <td>
                      <input type="text" name="description" value="DouPHP,轻量级企业网站管理系统" size="80" class="inpMain" />
                                </td>
         </tr>
                  <tr>
          ...
          <td>
                      <input type="text" name="address" value="福建省漳州市芗城区" size="80" class="inpMain" />
                                </td>
         </tr>
                  <tr>
          ...
          <td>
            ...
            <input type="radio" name="closed" id="site_closed_0" value="0" checked="true">
            否</label>
           <label for="site_closed_1">
            <input type="radio" name="closed" id="site_closed_1" value="1">
            是</label>
                                </td>
         </tr>
                  <tr>
