...
@section('content') 
 <div id="dcMain">
   <!-- 当前位置 -->
<div id="urHere">DouPHP 管理中心<b>></b><strong>网站管理员 注册</strong> </div>   <div id="manager" class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
    <h3><a href="/" class="actionBtn">登录</a>网站管理员 注册</h3>
           <form action="/admin/Addzhu" method="post">
    <input type="hidden" name="_token" value="{{csrf_token()}}">
     <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
      ...
      <tr>
       ...
       <td>
        <input type="password" name="pwd" size="40" class="inpMain" />
       </td>
      </tr>
      <tr>
       <td></td>
